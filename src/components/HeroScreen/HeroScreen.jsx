                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8">
                            <h1 className={`${styles.name}`}>I’m Naman <br />
                            ...
                            <div className={styles.Soicalicons}>
                                <ul className="d-flex">
                                    <li className={styles.liFirst}><a href="https://github.com/namanmalhan98"><i className="fab fa-github"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/namanmalhan/"> <i className="fab fa-linkedin-in"></i></a></li>
                                    {/* <li><a href="https://twitter.com/RanochTech"> <i className="fab fa-twitter"></i></a></li> */}
                                    <li><a href="mailto:namanmalhan18@gmail.com"> <i className="fas fa-envelope"></i></a></li>
                                    <li><a href="https://www.instagram.com/naman_malhan/"> <i className="fab fa-instagram"></i></a></li>
                                </ul>
                            </div>
